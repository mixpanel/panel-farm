...
var AnimalBadge = function (_Component) {
  ...
  _createClass(AnimalBadge, [{
    ...
    value: function connectedCallback() {
      ...
      _get(AnimalBadge.prototype.__proto__ || Object.getPrototypeOf(AnimalBadge.prototype), 'connectedCallback', this).apply(this, arguments);
      requestAnimationFrame(function () {
        return _this2.update();
      }); // firefox hacky hack for animations
    }
  }, {
    key: 'config',
    get: function get() {
      ...
      return {
        ...
        helpers: {
          ...
          clickClose: function clickClose() {
            ...
            _this3.update(); // firefox hacky hack for animations
          },
          isCloseable: function isCloseable() {
            return _this3.isAttributeEnabled('closeable');
          },
          isEnteringOrExiting: function isEnteringOrExiting() {
            return _this3.classList.contains('inout');
          }
        }
      };
    }
    ...
    return {
      value: h("div", {
        ...
        __jade_nodes = __jade_nodes.concat(h("p", function () {
          ...
          __jade_nodes = __jade_nodes.concat(" in your browser's dev tools. The code is available at");
          __jade_nodes = __jade_nodes.concat(function () {
            var __jade_nodes = [];
            __jade_nodes = __jade_nodes.concat(" ");
            __jade_nodes = __jade_nodes.concat(function () {
              ...
              __jade_nodes = __jade_nodes.concat(h("a", {
                "attrs": {
                  href: 'https://github.com/mixpanel/panel-farm'
                }
              }, [__vjadeSafeCode('https://github.com/mixpanel/panel-farm')]));;
              return __jade_nodes;
            }.call(this));
            __jade_nodes = __jade_nodes.concat(".");;
            return __jade_nodes;
